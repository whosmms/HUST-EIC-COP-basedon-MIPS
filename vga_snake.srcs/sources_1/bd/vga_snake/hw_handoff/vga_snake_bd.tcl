...
################################################################
# This is a generated script based on design: vga_snake
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gpio_btn [ create_bd_port -dir I -from 4 -to 0 gpio_btn ]
  set gpio_status_ext [ create_bd_port -dir O -from 21 -to 0 gpio_status_ext ]
  ...
  set vga_b [ create_bd_port -dir O -from 2 -to 0 vga_b ]
  set vga_g [ create_bd_port -dir O -from 2 -to 0 vga_g ]
  set vga_r [ create_bd_port -dir O -from 2 -to 0 vga_r ]
  ...
  if { [catch {set top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.ENEMY_MAX_LEN {8} \
   CONFIG.ENEMY_MIN_LEN {4} \
 ] $top_0

  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports push_buttons_5bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports dual_seven_seg_led_disp] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports gpio_btn] [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins top_0/gpio_btn]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mdm_1/M_AXI_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins top_0/rst_n]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net top_0_gpio_status [get_bd_ports gpio_status_ext] [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins top_0/gpio_status]
  connect_bd_net -net top_0_hsync [get_bd_ports hsync] [get_bd_pins top_0/hsync]
  connect_bd_net -net top_0_vga_b [get_bd_ports vga_b] [get_bd_pins top_0/vga_b]
  connect_bd_net -net top_0_vga_g [get_bd_ports vga_g] [get_bd_pins top_0/vga_g]
  connect_bd_net -net top_0_vga_r [get_bd_ports vga_r] [get_bd_pins top_0/vga_r]
