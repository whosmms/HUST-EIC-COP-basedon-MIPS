...
HD_PWD='D:/Xilinx/vga_snake/vga_snake.runs/vga_snake_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_snake_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_snake_axi_gpio_0_0.tcl
